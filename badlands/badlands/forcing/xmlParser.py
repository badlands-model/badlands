...
class xmlParser:
    ...
    def __init__(self, inputfile=None, makeUniqueOutputDir=True):
        ...
        if inputfile == None:
            raise RuntimeError(
                "XmL input file name must be defined to run a Badlands simulation."
            )
        ...
        self.spl = False
        self.deepbasin = -10000.0
        self.denscrit = 20000.0
    ...
    def _get_XmL_Data(self):
        ...
        if grid is not None:
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.demfile):
                    raise ValueError(
                        "DEM file is missing or the given path is incorrect."
                    )
            element = None
            ...
            if element is not None:
                ...
                if (
                    ...
                    and self.btype != "flat"
                    and self.btype != "wall"
                    and self.btype != "fixed"
                    and self.btype != "outlet"
                    and self.btype != "wall1"
                ):
                    raise ValueError(
                        "Error in the definition of the grid structure: Boundary type is either: flat, slope or wall"
                    )
            else:
                self.btype = "slope"
            element = None
            ...
            raise ValueError(
                "Error in the XmL file: grid structure definition is required!"
            )
        ...
        if time is not None:
            ...
            if self.restart:
                for rst in time.iter("restart"):
                    ...
                    if element is not None:
                        ...
                        raise ValueError(
                            "Error the restart folder name needs to be defined for the restart function to work"
                        )
                    element = None
                    ...
                    if element is not None:
                        ...
                        raise ValueError(
                            "Error the restart step number needs to be defined for the restart function to work"
                        )
            element = None
            ...
            if element is not None:
                ...
                raise ValueError(
                    "Error in the definition of the simulation time: start time declaration is required"
                )
            element = None
            ...
            if element is not None:
                ...
                raise ValueError(
                    "Error in the definition of the simulation time: end time declaration is required"
                )
            if self.tStart > self.tEnd:
                raise ValueError(
                    "Error in the definition of the simulation time: start time is greater than end time!"
                )
            element = None
            ...
            if element is not None:
                ...
                raise ValueError(
                    "Error in the definition of the simulation time: display time declaration is required"
                )
            if (self.tEnd - self.tStart) % self.tDisplay != 0:
                raise ValueError(
                    "Error in the definition of the simulation time: display time needs to be a multiple of simulation time."
                )
            element = None
            ...
            raise ValueError(
                "Error in the XmL file: time structure definition is required!"
            )
        ...
        if strat is not None:
            ...
            if self.tDisplay % self.laytime != 0:
                raise ValueError(
                    "Error in the XmL file: stratal layer interval needs to be an exact multiple of the display interval!"
                )
        ...
        if sea is not None:
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.seafile):
                    raise ValueError(
                        "Sea level file is missing or the given path is incorrect."
                    )
            else:
                self.seafile = None
        else:
        ...
        if tecto is not None:
            ...
            if element is not None:
                ...
                if tmpNb == 0:
                    raise ValueError(
                        "The number of tectonic events needs to be at least 1 or comment the tectonic structure."
                    )

            else:
                raise ValueError("The number of tectonic events needs to be defined.")
            tmpFile = numpy.empty(tmpNb, dtype=object)
            tmpuFile = numpy.empty(tmpNb, dtype=object)
            ...
            for disp in tecto.iter("disp"):
                ...
                if element is not None:
                    ...
                    raise ValueError(
                        "Displacement event %d is missing start time argument." % id
                    )
                element = None
                ...
                if element is not None:
                    ...
                    raise ValueError(
                        "Displacement event %d is missing end time argument." % id
                    )
                if tmpTime[id, 0] >= tmpTime[id, 1]:
                    raise ValueError(
                        "Displacement event %d start and end time values are not properly defined."
                        % id
                    )
                if id > 0:
                    if tmpTime[id, 0] < tmpTime[id - 1, 1]:
                        raise ValueError(
                            "Displacement event %d start time needs to be >= than displacement event %d end time."
                            % (id, id - 1)
                        )
                element = None
                ...
                if element is not None:
                    ...
                    if not os.path.isfile(tmpFile[id]):
                        raise ValueError(
                            "Displacement file %s is missing or the given path is incorrect."
                            % (tmpFile[id])
                        )
                else:
                    raise ValueError(
                        "Displacement event %d is missing file argument." % id
                    )

                element = disp.find("ufile")
                if element is not None:
                    tmpuFile[id] = element.text
                    if not os.path.isfile(tmpuFile[id]):
                        raise ValueError(
                            "Uplift/Subsidence file %s is missing or the given path is incorrect."
                            % (tmpFile[id])
                        )
                else:
                    tmpuFile[id] = None
            ...
            if id != tmpNb:
                raise ValueError(
                    "Number of events %d does not match with the number of declared displacement parameters %d."
                    % (tmpNb, id)
                )
            ...
            self.tectNb = 1
            self.tectTime = numpy.empty((self.tectNb, 2))
            self.tectTime[0, 0] = self.tEnd + 1.0e5
            self.tectTime[0, 1] = self.tEnd + 2.0e5
            self.tectFile = numpy.empty((self.tectNb), dtype=object)
            self.tectFile = None
            self.tectuFile = numpy.empty((self.tectNb), dtype=object)
            self.tectuFile = None
        ...
        if rivers is not None:
            ...
            for riv in rivers.iter("river"):
                if id >= self.riverNb:
                    raise ValueError(
                        "The number of rivers does not match the value of riverNb."
                    )
                element = None
        ...
        if precip is not None:
            ...
            for clim in precip.iter("rain"):
                if id >= tmpNb:
                    raise ValueError(
                        "The number of climatic events does not match the number of defined climates."
                    )
                element = None
                ...
                if element is not None:
                    ...
                    raise ValueError(
                        "Rain climate %d is missing start time argument." % id
                    )
                element = None
                ...
                if element is not None:
                    ...
                    raise ValueError(
                        "Rain climate %d is missing end time argument." % id
                    )
                if tmpTime[id, 0] >= tmpTime[id, 1]:
                    raise ValueError(
                        "Rain climate %d start and end time values are not properly defined."
                        % id
                    )
                if id > 0:
                    if tmpTime[id, 0] < tmpTime[id - 1, 1]:
                        raise ValueError(
                            "Rain climate %d start time needs to be >= than rain climate %d end time."
                            % (id, id - 1)
                        )
                element = None
                ...
                if element is not None:
                    ...
                    if not os.path.isfile(tmpMap[id]):
                        raise ValueError(
                            "Rain map file %s is missing or the given path is incorrect."
                            % (tmpMap[id])
                        )
                else:
                    tmpMap[id] = None
            ...
            if id != tmpNb:
                raise ValueError(
                    "Number of climates %d does not match with the number of declared rain parameters %d."
                    % (tmpNb, id)
                )
        ...
        if spl is not None:
            ...
            if element is not None:
                ...
                if self.diffprop <= 0 or self.diffprop >= 1:
                    raise ValueError(
                        "Proportion of marine sediment deposited on downstream nodes needs to be range between ]0,1["
                    )
            else:
                self.diffprop = 0.9
            element = None
            ...
            if dpropList.count(None) == 1:
                raise ValueError(
                    "Both <propa> and <propb> must be assigned to implement slope-dependent diffprop."
                )
            if (
                dpropList.count(None) == 2
            ):  # Assign them to real vals for input into pdalgo
                self.propa = 0.0
                self.propb = 0.0
        else:
            self.depo = 0
        ...
        if erost is not None:
            ...
            for rcktyp in erost.iter("rockero"):
                if id >= self.rockNb:
                    raise ValueError(
                        "The number of rock erodibilities values does not match the number of defined rock types."
                    )
                element = None
            ...
            for rcklay in erost.iter("erolay"):
                if id >= self.initlayers:
                    raise ValueError(
                        "The number of erodibility layer maps does not match the number of defined layers."
                    )
                element = None
        ...
        if erostruct is not None:
            ...
            for elay in erostruct.iter("erolay"):
                if id >= tmpNb:
                    raise ValueError(
                        "The number of erodibility layers events does not match the number of defined layers."
                    )
                element = None
                ...
                if element is not None:
                    ...
                    if not os.path.isfile(self.eroMap[id]):
                        raise ValueError(
                            "Erodibility map file %s is missing or the given path is incorrect."
                            % (self.eroMap[id])
                        )
                else:
                    self.eroMap[id] = None
                ...
                if element is not None:
                    ...
                    if not os.path.isfile(self.thickMap[id]):
                        raise ValueError(
                            "Thickness map file %s is missing or the given path is incorrect."
                            % (self.thickMap[id])
                        )
                else:
        ...
        if flex is not None:
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.elasticGrid):
                    raise ValueError(
                        "Elastic grid file is missing or the given path is incorrect."
                    )
            else:
                self.elasticGrid = None
            element = None
        ...
        if wavefield is not None:
            ...
            if element is not None:
                ...
                if (
                    self.waveOn
                    and Decimal(self.tEnd - self.tStart) % Decimal(self.tWave) != 0.0
                ):
                    raise ValueError(
                        "Error in the definition of the simulation time: wave interval needs to be a multiple of simulation time."
                    )
            else:
                raise ValueError(
                    "Error in the definition of the simulation time: wave interval is required"
                )
            ...
            if element is not None:
                ...
                raise ValueError(
                    "The number of wave temporal events needs to be defined."
                )
            element = None
            ...
            self.waveNb = 0
            self.tWave = self.tEnd - self.tStart + 10000.0
        ...
        if self.waveNb > 0:
            ...
            for wavedata in root.iter("wave"):
                if w >= tmpNb:
                    raise ValueError(
                        "Wave event number above number defined in global wave structure."
                    )
                if wavedata is not None:
                    ...
                    if element is not None:
                        ...
                        raise ValueError(
                            "Wave event %d is missing start time argument." % w
                        )
                    element = None
                    ...
                    if element is not None:
                        ...
                        raise ValueError(
                            "Wave event %d is missing end time argument." % w
                        )
                    if self.waveTime[w, 0] >= self.waveTime[w, 1]:
                        raise ValueError(
                            "Wave event %d start and end time values are not properly defined."
                            % w
                        )
                    element = None
                    ...
                    if element is not None:
                        ...
                        raise ValueError(
                            "Wave event %d is missing climatic wave number argument."
                            % w
                        )

                    if (
                        self.waveOn
                        and Decimal(self.waveTime[w, 1] - self.waveTime[w, 0])
                        % Decimal(self.tWave)
                        != 0.0
                    ):
                        raise ValueError(
                            "Wave event %d duration need to be a multiple of the wave interval."
                            % w
                        )
                    ...
                    for clim in wavedata.iter("climate"):
                        ...
                        if element is not None:
                            ...
                            if sumPerc > 1:
                                raise ValueError(
                                    "Sum of wave event %d percentage is higher than 1."
                                    % w
                                )
                            listPerc.append(float(element.text))
                            if listPerc[id] < 0:
                                raise ValueError(
                                    "Wave event %d percentage cannot be negative." % w
                                )
                        else:
                            raise ValueError(
                                "Wave event %d is missing percentage argument." % w
                            )
                        element = None
                        ...
                        if element is not None:
                            ...
                            if listWh[id] < 0:
                                raise ValueError(
                                    "Wave event %d significant wave height cannot be negative."
                                    % w
                                )
                        else:
                            listWh.append(0.001)
                        ...
                        if element is not None:
                            ...
                            if listWd[id] < 0:
                                raise ValueError(
                                    "Wave event %d wave direction needs to be set between 0 and 360."
                                    % w
                                )
                            if listWd[id] > 360:
                                raise ValueError(
                        ...
                        if self.waveOn:
                            ...
                            if element is not None:
                                ...
                                if listWp[id] <= 0:
                                    raise ValueError(
                                        "Wave event %d wave period cannot be negative."
                                        % w
                                    )
                            else:
                                listWp.append(30.0)
                            ...
                            if element is not None:
                                ...
                                if listWu[id] < 0:
                                    raise ValueError(
                                        "Wave event %d wind velocity cannot be negative."
                                        % w
                                    )
                            else:
                                listWu.append(0.0)
                            ...
                            if element is not None:
                                ...
                                if listWdd[id] < 0:
                                    raise ValueError(
                                        "Wave event %d wind direction needs to be set between 0 and 360."
                                        % w
                                    )
                                if listWdd[id] > 360:
                                    raise ValueError(
                            ...
                            if element is not None:
                                ...
                                if listWs[id] < 0:
                                    raise ValueError(
                                        "Wave event %d spreading angle needs to be set between 0 and 360."
                                        % w
                                    )
                                if listWs[id] > 360:
                                    raise ValueError(
                            ...
                            if element is not None:
                                ...
                                if listWside[id] > 8:
                                    raise ValueError(
                                        "Wave boundary side is between 1 and 8."
                                    )
                            else:
                                listWside[id] = 1
                        id += 1
        ...
        if self.waveOn:
            ...
            for t in range(len(twsteps)):
                ...
                for k in range(self.waveNb):
                    if (
                        self.waveTime[k, 0] <= twsteps[t]
                        and self.waveTime[k, 1] >= twsteps[t]
                    ):
                        c = k
        ...
        if carbp is not None:
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.baseMap):
                    raise ValueError(
                        "Basement map file for species1 growth is missing or the given path is incorrect."
                    )
            element = None
            element = carbp.find("tcarb")
            if element is not None:
                self.tCarb = float(element.text)
                if Decimal(self.tEnd - self.tStart) % Decimal(self.tCarb) != 0.0:
                    raise ValueError(
                        "Error in the definition of the simulation time: carbonate interval needs to be a multiple of simulation time."
                    )
            else:
                raise ValueError(
                    "Error in the definition of the simulation time: carbonate interval is required"
                )
            element = None
            ...
            if element is not None:
                ...
                raise ValueError(
                    "The number of carbonate growth events needs to be defined."
                )
            ...
            for clim in carbp.iter("event"):
                if id >= tmpNb:
                    raise ValueError(
                        "The number of reef growth events does not match the number of defined events."
                    )
                element = None
                ...
                if element is not None:
                    ...
                    raise ValueError(
                        "Reef growth event %d is missing start time argument."
                        % int(id + 1)
                    )
                element = None
                ...
                if element is not None:
                    ...
                    raise ValueError(
                        "Reef growth event %d is missing end time argument."
                        % int(id + 1)
                    )
                if tmpTime[id, 0] >= tmpTime[id, 1]:
                    raise ValueError(
                        "Reef growth event %d start and end time values are not properly defined."
                        % int(id + 1)
                    )
                if id > 0:
                    if tmpTime[id, 0] < tmpTime[id - 1, 1]:
                        raise ValueError(
                            "Reef growth event %d start time needs to be >= than rain climate %d end time."
                            % (int(id + 1), id)
                        )
            ...
            if id != tmpNb:
                raise ValueError(
                    "Reef growth event parameter %d does not match with the number of declared reef growth events %d."
                    % (tmpNb, id)
                )
            ...
            if tmpTime[id, 0] > self.tStart:
                self.carbValSp1[id] = 0.0
                self.carbValSp2[id] = 0.0
            ...
            self.carbValSp2 = numpy.empty(self.carbNb)
            self.carbTime = numpy.empty((self.carbNb, 2))
            self.carbValSp1[0] = 0.0
            self.carbValSp2[0] = 0.0
        ...
        if carb is not None:
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.carbDepth):
                    raise ValueError(
                        "Species1 depth control file is missing or the given path is incorrect."
                    )
            else:
                self.carbDepth = None
            element = None
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.carbWave):
                    raise ValueError(
                        "Species1 wave control file is missing or the given path is incorrect."
                    )
            else:
                self.carbWave = None
            element = None
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.carbSed):
                    raise ValueError(
                        "Species1 sedimentation control file is missing or the given path is incorrect."
                    )
            else:
                self.carbSed = None
            element = None
        ...
        if carb2 is not None:
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.carbDepth2):
                    raise ValueError(
                        "Species2 depth control file is missing or the given path is incorrect."
                    )
            else:
                self.carbDepth2 = None
            element = None
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.carbWave2):
                    raise ValueError(
                        "Species2 wave control file is missing or the given path is incorrect."
                    )
            else:
                self.carbWave2 = None
            element = None
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.carbSed2):
                    raise ValueError(
                        "Species2 sedimentation control file is missing or the given path is incorrect."
                    )
            else:
                self.carbSed2 = None
            element = None
        ...
        if pelagic is not None:
            ...
            if element is not None:
                ...
                if not os.path.isfile(self.pelDepth):
                    raise ValueError(
                        "Pelagic depth control file is missing or the given path is incorrect."
                    )
            else:
                raise ValueError(
                    "Depth control file on pelagic deposition is required."
                )
