...
ext1 = Extension(name    = 'badlands.flowalgo',
                 sources = ['utils/flowalgo.pyf', 'utils/flowalgo.f90'],
                 extra_link_args = ['utils/classfv.o'])

ext2 = Extension(name    = 'badlands.fvframe',
              sources = ['utils/fvframe.pyf', 'utils/fvframe.f90'],
              extra_link_args = ['utils/classfv.o'])

ext3 = Extension(name    = 'badlands.pdalgo',
              sources = ['utils/pdalgo.pyf', 'utils/pdalgo.f90'],
              extra_link_args = ['utils/classpd.o'])

ext4 = Extension(name    = 'badlands.ormodel',
              sources = ['utils/ormodel.pyf', 'utils/ormodel.f90'],
              extra_link_args = ['utils/classoro.o'])

ext5 = Extension(name    = 'badlands.waveseds',
              sources = ['utils/waveseds.pyf', 'utils/waveseds.f90'])

ext6 = Extension(name    = 'badlands.sfd',
              sources = ['utils/sfd.pyf', 'utils/sfd.c'])
...
if __name__ == "__main__":
    setup(name = 'badlands',
          ...
          packages          = ['badlands','badlands.flow','badlands.forcing','badlands.hillslope','badlands.simulation','badlands.surface','badlands.underland'],
          package_data      = {'badlands': [] ,'badlands':
                                          sys_includes},
